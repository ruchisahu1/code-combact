...
/**
 * Level Game Page - Dungeon Theme (CodeCombat-inspired)
 * Stone-framed panels, fantasy styling, immersive dungeon atmosphere
 */
...
import { getLevel, getAllLevels } from '@/lib/game/levels';
...
export default function LevelPage() {
  ...
  return (
    <div className="level-page">
      ...
      {/* Main Layout */}
      <main className="main">
        {/* Left: Large Game Area with Stone Frame */}
        <div className="game-section">
          <div className="game-wrapper">
            ...
            {/* Objectives Overlay - Scroll/Parchment Style */}
        ...
        {/* Right: Editor Panel - Ancient Tome Style */}
        <div className="editor-section">
          {/* File Tab - Scroll Header */}
          ...
          {/* Run/Reset Buttons - Big Embossed Style */}
          ...
          {/* Output Console - Crystal Ball Style */}
          ...
          {/* Commands Reference - Spellbook Style */}
      ...
      {/* Success Modal - Victory Celebration */}
      {showSuccess && (
      ...
      <style jsx>{`
        ...
        .victory-banner {
          ...
          background: 
            linear-gradient(180deg, rgba(139,105,20,0.3) 0%, transparent 50%),
            linear-gradient(180deg, #3d3020 0%, #2a2015 100%);
        }
        ...
        .next-btn:hover {
          background: linear-gradient(180deg, #aa8833 0%, #7a5533 100%);
        ...
        @media (max-width: 1024px) {
          ...
          .game-section { flex: none; height: 50vh; }
          .editor-section { flex: 1; border-left: none; border-top: 3px solid #3d3050; }
        }
        ...
        .failure-modal {
          ...
          box-shadow: 
            ...
            0 0 100px rgba(139,20,20,0.2);
        }

        .failure-banner {
          background: 
            linear-gradient(180deg, rgba(139,20,20,0.2) 0%, transparent 50%),
            linear-gradient(180deg, #302020 0%, #2a1515 100%);
        }

        .failure-title {
          color: #ff4a4a !important;
          text-shadow: 0 2px 10px rgba(255,100,100,0.3) !important;
        }

        .retry-btn {
          background: linear-gradient(180deg, #8b1414 0%, #5c0f0f 100%) !important;
          border: 2px solid #aa3333 !important;
        ...
        .retry-btn:hover {
          background: linear-gradient(180deg, #aa3333 0%, #7a1f1f 100%) !important;
